 ...
 */
public class GravityCorrAlgorithm extends BaseAlgorithm {
     ...
     */
    private static int baseCountInit = 50;
     ...
     * construct
     */
    public GravityCorrAlgorithm() {
        this.setConfiguration("");
    }

    @Override
    public SimulationAlgorithm copy() {
        GravityCorrAlgorithm simuAlg = new GravityCorrAlgorithm();
    ...
    public SimulationAlgorithm call() throws Exception {
        if (!running) {
            ...
            */
            ...
            setBaseCount(this.threadCount * this.baseCountAdditional);
    ...
    private synchronized void setBaseCount(int aCount){
    	baseCountInit += aCount;
    }
    /**
